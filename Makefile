...
MAIN = AVR-atmega32-4_Digit_7_Segment_Counter.c
...
flash_arduinoisp: PROGRAMMER_TYPE = arduinoisp
flash_arduinoisp: PROGRAMMER_ARGS = # ArduinoISP works with no further arguments
flash_arduinoisp: flash
...
LFUSE = 0xff
HFUSE = 0x89
#EFUSE = 0xFD # ATMega doesn't have Extended Fuse

## Generic 
#FUSE_STRING = -U lfuse:w:$(LFUSE):m -U hfuse:w:$(HFUSE):m -U efuse:w:$(EFUSE):m 
FUSE_STRING = -U lfuse:w:$(LFUSE):m -U hfuse:w:$(HFUSE):m # Removed the extended fuse 
